...
namespace Testing
{
	...
	public:
		...
		TEST_METHOD(TestCCityEmpty)
		{
			...
			Assert::AreEqual(0, visitor.mNumRoads, L"Visitor number of roads = 0");
			Assert::AreEqual(0, visitor.mNumBuildings, L"Visitor number of buildings = 0");
			Assert::AreEqual(0, visitor.mNumLandscapes, L"Visitor number of landscapes = 0");
			Assert::AreEqual(0, visitor.mNumCoalmines, L"Visitor number of coalmines = 0");
		}
